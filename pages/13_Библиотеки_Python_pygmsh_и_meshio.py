...
if choice == "Библиотека Python pygmsh":
    ...
    st.write("""
    `meshio` — это библиотека для работы с файлами сеток (mesh files) в Python \n\nОна предоставляет унифицированный интерфейс для чтения, записи и обработки сеток в различных форматах, таких как `.msh`, `.vtk`, `.stl`, `.xdmf` и многих других
    """)
